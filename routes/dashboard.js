...
mqttClient.on("message", (topic, message) => {
  ...
  if (topic.startsWith("RPM/output/")) {
    try {
      ...
      const { RPM, nama_pengguna, t, PWM } = data;

      console.log(
        `RPM: ${RPM}, Name: ${nama_pengguna}, Time: ${t}, PWM: ${PWM}`
      );

      if (dbClient) {
        const query = `INSERT INTO output (rpm, nama_pengguna, t, pwm) VALUES ($1, $2, $3, $4)`;
        dbClient.query(query, [RPM, nama_pengguna, t, PWM], (err) => {
